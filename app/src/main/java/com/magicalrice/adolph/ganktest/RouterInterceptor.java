...
public class RouterInterceptor implements IInterceptor {
    ...
    public void process(Postcard postcard, InterceptorCallback callback) {
        if (postcard.getPath().contains(ARouterPath.GIRLS_LIST_ATY)) {
            Logger.e("拦截到向ActivityGirls跳转");
            //自定义拦截
        } else {
            Logger.e("非拦截跳转执行Path"+postcard.getPath());
        }
    ...
    public void init(Context context) {
        ...
        Logger.e("RouterInterceptor init");
    }
}
